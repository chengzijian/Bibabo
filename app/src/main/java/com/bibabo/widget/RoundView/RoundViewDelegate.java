package com.bibabo.widget.RoundView;
...
public class RoundViewDelegate {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RoundViewAttr);
        backgroundColor = ta.getColor(R.styleable.RoundViewAttr_rBackgroundColor, Color.TRANSPARENT);
        backgroundPressColor = ta.getColor(R.styleable.RoundViewAttr_backgroundPressColor, Integer.MAX_VALUE);
        cornerRadius = ta.getDimensionPixelSize(R.styleable.RoundViewAttr_cornerRadius, 0);
        strokeWidth = ta.getDimensionPixelSize(R.styleable.RoundViewAttr_strokeWidth, 0);
        strokeColor = ta.getColor(R.styleable.RoundViewAttr_rStrokeColor, Color.TRANSPARENT);
        strokePressColor = ta.getColor(R.styleable.RoundViewAttr_strokePressColor, Integer.MAX_VALUE);
        textPressColor = ta.getColor(R.styleable.RoundViewAttr_textPressColor, Integer.MAX_VALUE);
        isRadiusHalfHeight = ta.getBoolean(R.styleable.RoundViewAttr_isRadiusHalfHeight, false);
        isWidthHeightEqual = ta.getBoolean(R.styleable.RoundViewAttr_isWidthHeightEqual, false);
        cornerRadius_TL = ta.getDimensionPixelSize(R.styleable.RoundViewAttr_cornerRadius_TL, 0);
        cornerRadius_TR = ta.getDimensionPixelSize(R.styleable.RoundViewAttr_cornerRadius_TR, 0);
        cornerRadius_BL = ta.getDimensionPixelSize(R.styleable.RoundViewAttr_cornerRadius_BL, 0);
        cornerRadius_BR = ta.getDimensionPixelSize(R.styleable.RoundViewAttr_cornerRadius_BR, 0);
        isRippleEnable = ta.getBoolean(R.styleable.RoundViewAttr_isRippleEnable, false);
